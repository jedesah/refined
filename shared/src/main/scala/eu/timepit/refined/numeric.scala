 ...
 * }}}
 */
object numeric extends NumericValidators with NumericShowInstances with NumericInferenceRules {
...
private[refined] trait NumericShowInstances {
